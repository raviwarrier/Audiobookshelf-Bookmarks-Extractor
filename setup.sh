#!/usr/bin/env bash
# ==============================================================================
# Audiobookshelf Bookmarks Extractor - Interactive Setup Wizard
...
echo -e "\n${BOLD}${CYAN}=================================================================${NC}"
echo -e "${BOLD}${CYAN}   Audiobookshelf Bookmarks Extractor - Server Configuration${NC}"
echo -e "${BOLD}${CYAN}=================================================================${NC}\n"
...
echo -e "   ${YELLOW}Note: 13378 is Audiobookshelf's default port. The extractor connects to it, but does not listen on it.${NC}"
...
cat > "$ENV_FILE" <<EOF
# Audiobookshelf Bookmarks Extractor - Configuration
