#!/usr/bin/env python3
"""
Audiobookshelf Bookmarks Extractor - Interactive Setup Assistant
...
def main():
    ...
    print("\n" + "=" * 65)
    print("   Audiobookshelf Bookmarks Extractor - Server Configuration")
    print("=" * 65)
    ...
    print("   Note: 13378 is Audiobookshelf's default port. The extractor connects to it; it does NOT listen on 13378.")
    ...
    env_content = f"""# Audiobookshelf Bookmarks Extractor - Configuration
